		...
		<div class="container">
			<div class="row">
				<form id="contactForm1" method="post" action="control.jsp"
					name="form2">
					<input type=hidden name="action" value="patient_insert">
					<h3>환자의 정보를 입력하세요(1)</h3>
					<p>식별 번호</p>
					<div class="col-md-12">
					...
					<p class="phone">
						Phone: <span>(ex 010-0000-0000)</span>
					<div class="col-md-12">
						<div class="form-group">
					...
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" name="protector_name"
					...
					<p class="phone">
						보호자 Phone: <span>(ex 010-0000-0000)</span>
					<div class="col-md-12">
						<div class="form-group">
							<input type="text" class="form-control" name="protector_phone"
								required data-error="Please enter your name">
							<div class="help-block with-errors"></div>
						</div>
					</div>
