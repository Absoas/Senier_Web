...
<jsp:useBean id="datas1" scope="request" class="java.util.ArrayList" />
	...
	<br>
		<div class="section-header">
			<h2 class="section-title wow fadeIn" data-wow-duration="1000ms"
				data-wow-delay="0.3s" style="text-align:center;">전체 리스트</h2>
		...
		<table class="table-style-two">
			...
			<%
				for (Patient_DO pa : (ArrayList<Patient_DO>) datas1) {
			%>
			<tr>
				<td><a href="javascript:check(<%=pa.getId()%>)"><%=pa.getId()%></a></td>
				<td><%=pa.getName()%></td>
				<td><%=pa.getAge()%></td>
				<td><%=pa.getPatient_room()%></td>
			</tr>
			<%
				}
			%>
